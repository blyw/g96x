...
void FrameGeometry::TrajectoryPositionBlockLineParser(Structs::GenericParameters &params, std::string &line, int &positionBlock_counter, std::vector<std::string> *prefix, Eigen::MatrixXd *coordinates)
{
...
void FrameGeometry::WriteOutFrame(Structs::FrameGeometric *framedata, gz::ogzstream &outfile, Structs::GenericParameters *me) {
	//check if it is possible to read file
	if (!outfile)
	{
...
void FrameGeometry::CorrectionRotational(Structs::FrameGeometric *framedata, Structs::FrameGeometric *ref_framedata, Structs::GenericParameters *me) {
