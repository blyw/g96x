...
public:
    ...
    static void WriteOutFrame(Structs::FrameGeometric *framedata, gz::ogzstream &outfile, Structs::InputParametersFrameout *me);
    static void CorrectionRotational(Structs::FrameGeometric *framedata, Structs::FrameGeometric *ref_framedata, Structs::InputParametersFrameout *me);
};
