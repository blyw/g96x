...
env.Append(CPPPATH=['.',
 '/pool2/lai/prog/shared-lib/eigen-3.2.0',
 '/pool2/lai/prog/ubuntu-12.04/libxml2-2.9.1/include/libxml2',
 ])
env.Append(LIBPATH=['/pool2/lai/prog/ubuntu-12.04/libxml2-2.9.1/lib','/pool2/lai/prog/ubuntu-12.04/zlib-1.2.8/lib'])
...
SConscript('checkboxX/SConscript', variant_dir='.build_' + build_dir)
