...
void InputParameters::ParseInputFile(Structs::GenericParameters *this_params, std::string job_id)
{
    ...
    for (int i = 0; i < xpathObj->nodesetval->nodeNr; i++)
    {
        ...
        this_params->distance_cut_off = atof(XPathGetText("./analysis/checkbox/distance_cut_off", xpathCtx));
        //set solventsphere truncation
        this_params->verbosity = atoi(XPathGetText("./analysis/checkbox/output_verbosity_level", xpathCtx));
